...
class AppColors {
  ...
  static Color accent = const Color(0xFF7BCFE9);
  static Color accentRipple = const Color(0xFF0E95C0);
  ...
  static Color lemon = const Color(0xffC7DC5B);
  static Color yellowLite = const Color( 0xffFED883);
  static Color orange = const Color( 0xffFFA771);
  static Color pinkLite = const Color( 0xffFF809F);
